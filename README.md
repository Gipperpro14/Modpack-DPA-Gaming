...
* Cuota inicial de 10. (Aumenta 10 por cada cuerpo no recuperado y aproximadamente 120 al terminar la cuota)
* Sistema de perks, terminal remota y mejorado sistema de XP para el nivel del usuario.
* **“Solo los valientes entrarán, pero solo los mejores sobrevivirán”**. No podrás salir por la entrada principal y no podrás entrar por la salida de fuego, lo que significa un desafío de exploración y mejor preparación antes de entrar a cada instalación.
...
* La puerta de la nave **puede matarte** si estas entre ella y su cerrado.
...
* Durante la huida del reactor de energía recibas daño cada hora en el juego.
...
* Poder llevarse ciertos objetos mediante el inverse teleporter. **(50% de la batería)**
* Guarda y organiza tus items en el **mueble del gabinete**. (Equipamiento y scrap del mismo tamaño, no admite scrap que tenga que ser llevado en ambas manos)
...
* Nuevo scrap.
* Barra de advertencia que si al llenarse usando el jetpack **hará que explote**.
* **Skipea** la selección de online o Lan.
* Añade de cuanto es tu **ping**.
...
* **Añade más de 380 efectos de sonido** para ambientar la experiencia y hacerla más inmersiva.
* Encuentra el nuevo scrap de maxwell.
* Permite que puedas ver el **nombre de tus compañeros** desde mayores distancias y **un icono** de voz aparecerá encima de ellos al hablar.
* No hay limite a la cantidad de cosas que puedes vender a la vez, pon todo de una y luego vende.
* Añade un botón para poder **abrir la puerta desde el exterior**.
* Puedes escanear para ver **cuántos enemigos** hay en el mapa spawneados.
* Puedes **mutearte** presionando solo la tecla M.
* **Stamina infinita** en las instalaciones de la compañía.
* Añade una alerta de descuento si hay uno en la tienda.
...
* Entre los cosméticos que puedes usar están: 
    ...
    - Cosméticos de Anime.
    - Cosméticos de Fnaf.
    - Cosméticos de Armadura de Diamante.
...
* Entre los trajes que puedes usar están: 
    ...
    - Trajes de SCP Foundation.
    - Trajes luminiscentes.
* Cambia tus cosméticos **in-game**.
* Si eres despedido sonora la música de **"Free Bird"**.
* Añade efectos visuales a tu pantalla dependiendo del daño recibido. (El efecto se restaura al **terminar la jornada**)
* Aumenta la cantidad de trajes en la nave.
* Spawnearan **moscas en los cuerpos muertos** de tus compañeros.
* Añade más de **200 emotes**.
...
* B o N = Para moverte en la página de trajes que puedes usar.
* ` (botón arriba de TAB) = Para abrir el menú de emotes.
...
* Enemies = Escribe este comando en la terminal para ver una lista de los enemigos o entidades spawneadas
* (A como recuerde más comandos los iré poniendo por acá).

## Recomendación sobre los controles
* Recomiendo a los jugadores a desactivar el baile y el apuntar con el dedo (emotes vainilla) en la configuración de las teclas para que cuando presiones el 1 o el 2 para moverte en tu inventario no bailes o apuntes por accidente.